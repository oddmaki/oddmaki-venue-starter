...
export type SemiCircularProgressProps = IconSvgProps & {
  percentage: number;
};
...
export const SemiCircularProgress = (props: SemiCircularProgressProps) => {
  const { size = 80, width, height, percentage, ...rest } = props;
  ...
  return (
    <svg
      height={height || (width ? undefined : size)}
      viewBox="0 0 80 80"
      width={width || (height ? undefined : size)}
      {...rest}
    >
      {/* Background arc */}
      <path
